...
void trajectory_1(WbDeviceTag dev_left_motor, WbDeviceTag dev_right_motor, bool acc_cal)
{
  ...
  double t;
  if (acc_cal) {
    t = wb_robot_get_time() - 5.0;   // modified
  }
  else {
    t = wb_robot_get_time();
  }
