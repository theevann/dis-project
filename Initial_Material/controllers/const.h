...
#define D_FLOCK 0.5     // TO DEFINE: targeted flocking distance
#define D_MAX_FLOCK 0.5 // TO DEFINE: maximum distance travelled in 1 timestep: timestep * maximum speed
